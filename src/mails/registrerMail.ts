...
<p>
    Thanks for registrer on website and welcome on our universe. You have one last thing to do before using your personal space: validate your email address by clicking on the button below.
</p>
...
Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem magnam labore voluptatum quasi sequi ullam tempora placeat id ducimus, voluptate perferendis et, expedita qui provident distinctio, molestiae doloremque. Numquam, maiores.
`
export default async function registrerMail({username, email, link}: { username: string, email: string, link: string }) {
